...
// Should be no bugs, but keep an eye out.
...
const tokens = {}; // tokens for our sample users
...
beforeEach(async function() {
  ...
  let sampleUsers = [
    ["u1", await _pwd("pwd1"), "fn1", "ln1", "pwd1@email1.com", "(111) 111-1111", false],
    ["u2", await _pwd("pwd2"), "fn2", "ln2", "pwd2@email2.com", "(222) 222-2222", false],
    ["u3", await _pwd("pwd3"), "fn3", "ln3", "pwd3@email3.com", "(333) 333-3333", true]
  ];

  for (let user of sampleUsers) {
    await db.query(
      `INSERT INTO users VALUES ($1, $2, $3, $4, $5, $6, $7)`,
      user // BUG???? NO BRACKETS.
    );
